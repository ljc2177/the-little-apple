<template>
  <div id="container">
    ...
    <div id="controls" ref="controls" @mouseup="showPopup()">
      ...
      <h3>Total Area</h3>
      <vue-slider v-bind="options" ref="slider" v-model="area" :min="0" :max="732" :tooltip-formatter="'{value} acre(s)'" :clickable="false" :enable-cross="false" :range="true" :style="sliderStyle" :railStyle="dotStyle" :processStyle="railStyle" :tooltipStyle="railStyle"></vue-slider>
      ...
      <vue-slider v-bind="options" v-model="highways" :min="0" :max="3.6" :interval="0.1" :range="true" :tooltip-formatter="'{value} mile(s)'" :clickable="false" :enable-cross="false" :style="sliderStyle" :railStyle="dotStyle" :processStyle="railStyle" :tooltipStyle="railStyle"></vue-slider>
      ...
      <vue-slider v-bind="options" v-model="foodins" :min="0" :max="11.4" :interval="0.1" :range="true" :tooltip-formatter="'{value} mile(s)'" :clickable="false" :enable-cross="false" :style="sliderStyle" :railStyle="dotStyle" :processStyle="railStyle" :tooltipStyle="railStyle"></vue-slider>
      ...
      <vue-slider v-bind="options" v-model="lowinc" :min="0" :max="11.4" :interval="0.1" :range="true" :tooltip-formatter="'{value} mile(s)'" :clickable="false" :enable-cross="false" :style="sliderStyle" :railStyle="dotStyle" :processStyle="railStyle" :tooltipStyle="railStyle"></vue-slider>
...
export default {
  ...
  data() {
    return {
      ...
      quotes: [
      {
        ...
        {
          content: 'One model that has been explored in the Portland, Maine urban agriculture program is a common share model: instead of individual plots, the food is all grown collectively and the labor/responsibilities is divided among the participating individuals. This has been a particularly good model for people who are new to growing food who want to learn more, or who are new to the area who want to meet more people and grow their sense of community.',
        },
        {
  ...
  mounted() {
    ...
    const map = new mapboxgl.Map({
      container: 'map',
      style: 'mapbox://styles/ljc2177/clgsxesps005y01pd0ml00521',
      minZoom: 11,
      center: [-74.20010, 40.573058],
      maxBounds: [
        [-74.498,40.277], // Southwest coordinates
        [-73.826,40.880] // Northeast coordinates
      ],
    })

    const filterLayers = ['statenisland-dhhi09'];
    ...
    const downloadCSV = () => {
      ...
      a.href = url;
      a.download = 'StatenIslandUrbanAgLocations.csv';
